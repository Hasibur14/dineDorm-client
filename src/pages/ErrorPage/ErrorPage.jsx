        ...
        <div>
            <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                    ...
                    <h3 className="text-4xl font-semibold text-primary flex">Error 404 <MdErrorOutline className="text-5xl ml-2  " /></h3>
                    <Link to='/'>
                        <button
                        ...
                        to-[#34d1bc] mr-4 flex text-center justify-center">
